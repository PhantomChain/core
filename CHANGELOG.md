...
-   Mphantom semantically invalid versions as invalid overall ([#1836])
...
-   Mphantom cold wallets as not found in the legacy API ([#1955])
...
-   https://github.com/PhantomChain/security-vulnerabilities/blob/master/core/core-sv-008.md
