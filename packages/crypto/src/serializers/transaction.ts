...
// Reference: https://github.com/PhantomChain/AIPs/blob/master/AIPS/aip-11.md
class TransactionSerializer {
    ...
    private serializeCommon(transaction: ITransactionData, buffer: ByteBuffer): void {
        ...
        buffer.writeByte(transaction.network || configManager.get("pubKeyHash")); // phantom = 0x37, devnet = 0x30
